...
import "./Profile.css"
import ProfilePicture from "../../img/elmir2.webp"
function Profile() {
  return (
      ...
      <div className="profilContainer">
        <div className="profilItem">
          <div className="profilLeft">
            <div className="profileimg"><img src={ProfilePicture} /></div>
            <div className="profiletextAll">
              <div><p>imnotlmirrr</p></div>
              <div style={{ fontSize: "13px", color: "#676464" }}>Elmir Babashli</div>
            </div>
          </div>
